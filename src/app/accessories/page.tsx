...
export default function AccessoriesPage() {
  ...
  const accessories = [
    { 
      name: "KRYPTIC STUDIOS Beanie", 
      price: "$15", 
      image: "/products/veil-cap.jpg", 
      description: "Warm beanie with embroidered KRYPTIC STUDIOS logo" 
    },
    { 
      name: "CREATIVE REBELLION Beanie", 
      price: "$15", 
      image: "/products/veil-cap.jpg", 
      description: "Underground creative community beanie" 
    },
    { 
      name: "KRYPTIC STUDIOS Sticker Pack", 
      price: "$8", 
      image: "/products/veil-cap.jpg", 
      description: "Set of 10 vinyl stickers featuring studio branding" 
    },
    { 
      name: "MISFITS UNITE Pin Set", 
      price: "$10", 
      image: "/products/veil-cap.jpg", 
      description: "Enamel pins for your collection - 3 piece set" 
    },
    { 
      name: "ARTISTS ONLY Tote Bag", 
      price: "$10", 
      image: "/products/veil-cap.jpg", 
      description: "Canvas tote bag with KRYPTIC STUDIOS screen print" 
    },
    { 
      name: "UNDERGROUND CREATIVE Keychain", 
      price: "$6", 
      image: "/products/veil-cap.jpg", 
      description: "Metal keychain with laser-etched studio logo" 
    },
  ];
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-8">
                ...
                <Link href="/accessories" className="text-white hover:text-gray-300 px-3 py-2 text-sm font-medium">
                  Accessories
                </Link>
